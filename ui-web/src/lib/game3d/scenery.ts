...
export class Scenery3D {
    ...
    /**
     * Place scenery around the circular arena edge
     * 
     * AI OPTIMIZATION (Dec 2025): Trees and crystals DISABLED
     * - Removed 32 trees around edge (visual clutter)
     * - Removed 4 cardinal crystals (distracting)
     * - Kept ambient particles (minimal, adds depth)
     * 
     * Result: Cleaner arena, better focus on gameplay
     */
    populateMazeEdges(mazeWidth: number, mazeHeight: number, _wallPositions: Set<string>): void {
        // Trees and crystals DISABLED per AI recommendation
        // They were identified as "diluting focus" and "distracting from core gameplay"
        
        // Only add minimal ambient particles for depth
